...
trait Path
{
    ...
    private function setDirectory($offset = 2)
    {
        ...
        //     if ($i == count($array) - 1) {
        //         $this->directory .= str_replace('_controller', '', Str::snake($array[$i]));
        //     } else {
        //         $this->directory .= Str::snake($array[$i]) . '.';
        //     }
        // }

        $this->directory .= str_replace('_controller', '', Str::snake($array[2])) . '.';
        $this->directory .= str_replace('_controller', '', Str::snake($array[3]));
    }
